...
"#;
        ...
        main.sql:1:3: warning: require-timeout-settings Missing `set lock_timeout` before possibly slow operations
        main.sql:1:3: warning: require-timeout-settings Missing `set statement_timeout` before possibly slow operations
