...
create aggregate commented_negative (sfunc = transition_function, stype = bigint, initcond /* before equals */ = /* before minus */ - /* after minus */ 100 /* after value */);

create aggregate public.old_style_sort_operator (sfunc = public.sort_state, basetype = integer, stype = bigint, sortop = <);

create aggregate public.commented_sort_operator(integer) (sfunc = public.sort_state, stype = bigint, /* sort operator */ sortop /* equals */ = /* less-than operator */ < /* closing parenthesis */);
