...
create constraint trigger constraint_options after insert on foo not valid no inherit not enforced enforced for each row execute function foo();

create constraint trigger commented_constraint_options after insert on foo /*a*/ not /*b*/ valid /*c*/ no /*d*/ inherit /*e*/ not /*f*/ enforced /*g*/ enforced /*h*/ for each row execute function foo();
