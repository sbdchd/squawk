...
create unlogged table events (id int) without oids;

create table typed_table of public.record_type;

create table measurements partition of events for values from (minvalue, 1) to (maxvalue, 100);

create table statuses partition of events for values in ('new', 'ready', 'a status value which makes this create table statement longer than eighty characters');
...
-- comments in every clause position
create /*a*/ local /*b*/ temporary /*c*/ table /*d*/ if /*e*/ not /*f*/ exists /*g*/ commented
(/*h*/ id int /*i*/)
/*j*/ inherits /*k*/ (/*l*/ parent /*m*/, /*n*/ archive.parent /*o*/)
/*p*/ partition /*q*/ by /*r*/ hash /*s*/ (/*t*/ id /*u*/)
/*v*/ using /*w*/ heap
/*x*/ with /*y*/ (fillfactor /*z*/ = /*aa*/ 70 /*ab*/)
/*ac*/ on /*ad*/ commit /*ae*/ preserve /*af*/ rows
/*ag*/ tablespace /*ah*/ fast;

create table child /*a*/ partition /*b*/ of /*c*/ parent
/*d*/ for /*e*/ values /*f*/ from /*g*/ (/*h*/ minvalue /*i*/, /*j*/ 1 /*k*/)
