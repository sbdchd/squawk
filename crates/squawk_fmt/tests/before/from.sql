...
select * from lateral cast(a_very_long_expression_name as a_very_long_schema_name.a_very_long_type_name) as converted;
select * from collation for (foo) as collation_name;
select * from /* before lateral */ lateral /* before cast */ cast /* before opening paren */ ( /* before expression */ value /* before as */ as /* before type */ int8 /* before closing paren */ ) /* before alias */ as /* before alias name */ converted;
select * from (select 1) as selected;
select * from lateral (select a_very_long_parenthesized_select_expression from a_very_long_parenthesized_select_relation_name) as a_very_long_parenthesized_select_alias;
select * from /* before lateral */ lateral /* before opening paren */ ( /* before select */ select /* before target */ value /* before closing paren */ ) /* before alias */ as /* before alias name */ selected;
...
select * from lateral a_very_long_function_name(a_very_long_first_argument_name, a_very_long_second_argument_name, a_very_long_third_argument_name) with ordinality as a_very_long_function_alias(a_very_long_value_column_alias, a_very_long_ordinality_column_alias);
...
select * from (a join b on a.id = b.id) as joined_tables;
