...
select varchar(10) 'abc', character varying(10) 'abc', national character varying(10) 'abc', nchar(10) 'abc', bit(3) '101', bit varying(3) '101', numeric(10, 2) '10', foo(1) '100', foo.bar(10, 2) '100', foo.select 'x';
