...
use crate::{ErrorCode, Ignore};

pub(crate) struct IgnoreIndex {
    line_to_ignored_names: HashMap<u32, HashSet<ErrorCode>>,
...
impl IgnoreIndex {
    pub(crate) fn new(text: &str, ignores: &[Ignore]) -> Self {
        ...
        let mut line_to_ignored_names: HashMap<u32, HashSet<ErrorCode>> = HashMap::new();
    ...
    pub(crate) fn contains(&self, range: TextRange, error_name: ErrorCode) -> bool {
