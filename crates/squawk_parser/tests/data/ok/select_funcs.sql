...
select extract('century' from a);
select extract('day' from a);
select extract('decade' from a);
select extract('dow' from a);
select extract('doy' from a);
select extract('epoch' from a);
select extract('hour' from a);
select extract('isodow' from a);
select extract('isoyear' from a);
select extract('julian' from a);
select extract('microseconds' from a);
select extract('millennium' from a);
select extract('milliseconds' from a);
select extract('minute' from a);
select extract('month' from a);
select extract('quarter' from a);
select extract('second' from a);
select extract('timezone' from a);
select extract('timezone_hour' from a);
select extract('timezone_minute' from a);
select extract('week' from a);
select extract('year' from a);
