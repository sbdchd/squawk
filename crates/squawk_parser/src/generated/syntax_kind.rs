...
pub enum SyntaxKind {
    ...
    DROP_OP_CLASS_OPTION,
    DROP_OP_CLASS_OPTIONS,
    DROP_OP_CLASS_OPTION_LIST,
    DROP_OWNED,
    DROP_POLICY,
    DROP_PROCEDURE,
    DROP_PROPERTY_GRAPH,
    ...
    EVENT_TRIGGER,
    EVENT_TRIGGER_EVENT,
    EVENT_TRIGGER_FILTER_VARIABLE,
    EVENT_TRIGGER_REF,
    EVENT_TRIGGER_RENAME_TO,
    EVENT_TRIGGER_WHEN,
    ...
    EXPR_AS_COLUMN_NAME,
    EXPR_AS_COLUMN_NAME_LIST,
    EXPR_AS_ELEMENT_TAG,
    EXPR_AS_ELEMENT_TAG_LIST,
    EXPR_AS_PROPERTY_NAME,
    EXPR_AS_PROPERTY_NAME_LIST,
    EXPR_AS_XML_ATTR,
    EXPR_AS_XML_ATTR_LIST,
    EXPR_FOLLOWING,
    EXPR_FROM_ITEM,
    EXPR_PRECEDING,
    EXPR_TYPE,
    ...
    FOREIGN_DATA_WRAPPER_REF,
    FOREIGN_DATA_WRAPPER_RENAME_TO,
    ...
    JSON_TABLE_PLAN_CHOICE,
    JSON_TABLE_PLAN_CLAUSE,
    JSON_TABLE_PLAN_JOIN,
    JSON_VALUE_EXPR,
    JSON_VALUE_FN,
    JSON_VARIABLE_NAME,
    ...
    OP,
    OPERATOR_CALL,
    OPERATOR_CLASS_OPTION_LIST,
    OPERATOR_FAMILY_CLAUSE,
    OPTIONAL_AS_ALIAS,
    OPTION_ITEM,
    OPTION_ITEM_LIST,
    OP_CLASS_NAME,
    ...
    PREPARE,
    PREPARED_STATEMENT,
    PREPARED_STATEMENT_REF,
    PREPARE_TRANSACTION,
    PRESERVE_ROWS,
    PRIMARY_KEY_CONSTRAINT,
    PRIOR,
    PRIVILEGES,
    PRIVILEGE_ALL_IN_SCHEMA,
    PRIVILEGE_DEFAULT,
    PRIVILEGE_FOREIGN,
    PRIVILEGE_LARGE_OBJECT,
    PRIVILEGE_NAME,
    PRIVILEGE_PARAMETER,
    PRIVILEGE_PROPERTY_GRAPH,
    PRIVILEGE_ROUTINE,
    PRIVILEGE_TABLE,
    PRIVILEGE_TARGET,
    PRIVILEGE_TYPE,
    ...
    PROPERTY_GRAPH,
    PROPERTY_GRAPH_REF,
    PROPERTY_GRAPH_RENAME_TO,
    PROPERTY_NAME,
    PROPERTY_NAME_REF,
    PUBLICATION,
    PUBLICATION_OBJECT,
    PUBLICATION_REF,
    PUBLICATION_RENAME_TO,
    RANGE_TYPE,
    READ_COMMITTED,
    READ_ONLY,
    READ_UNCOMMITTED,
    ...
    TEXT_SEARCH_CONFIGURATION_REF,
    TEXT_SEARCH_CONFIGURATION_RENAME_TO,
    TEXT_SEARCH_DICTIONARY,
    TEXT_SEARCH_DICTIONARY_REF,
    TEXT_SEARCH_DICTIONARY_RENAME_TO,
    TEXT_SEARCH_PARSER,
    TEXT_SEARCH_PARSER_REF,
    TEXT_SEARCH_PARSER_RENAME_TO,
    TEXT_SEARCH_TEMPLATE,
    TEXT_SEARCH_TEMPLATE_REF,
    TEXT_SEARCH_TEMPLATE_RENAME_TO,
    TEXT_SEARCH_TOKEN_KIND,
    TIES,
    TIME_TYPE,
    TIME_ZONE,
    TIMING,
