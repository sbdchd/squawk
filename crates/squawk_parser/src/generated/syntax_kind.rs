...
pub enum SyntaxKind {
    ...
    ALTER_TRIGGER,
    ALTER_TYPE,
    ALTER_TYPE_ATTRIBUTE_ACTION_LIST,
    ALTER_USER,
    ALTER_USER_MAPPING,
    ...
    COPY_OPTION,
    COPY_OPTION_ARG,
    COPY_OPTION_ARG_LIST,
    COPY_OPTION_KEY,
    COPY_OPTION_LIST,
    COPY_OPTION_VALUE,
    COPY_OPTION_VALUE_NAME,
    COPY_PROGRAM,
    COPY_QUERY,
    COPY_STDIN,
    COPY_STDOUT,
    ...
    EXTENSION_SCHEMA,
    EXTENSION_VERSION,
    EXTENSION_VERSION_CLAUSE,
    EXTRACT_FIELD_LITERAL,
    EXTRACT_FIELD_NAME,
    EXTRACT_FN,
    FDW_OPTION_LIST,
    FETCH,
    ...
    OBJECT_TABLE,
    OBJECT_TABLESPACE,
    OBJECT_TEXT_SEARCH_CONFIG,
    OBJECT_TEXT_SEARCH_DICT,
    OBJECT_TEXT_SEARCH_PARSER,
    OBJECT_TEXT_SEARCH_TEMPLATE,
    OBJECT_TRANSFORM,
    OBJECT_TRIGGER,
    OBJECT_TYPE,
    OBJECT_VIEW,
    ...
    OPTION_UNLOGGED,
    OPTION_VALIDATOR,
    OP_CLASS_FOR_ORDER_BY,
    OP_CLASS_FOR_SEARCH,
    OP_CLASS_NAME,
    OP_CLASS_OPTION_FUNCTION,
    OP_CLASS_OPTION_OPERATOR,
    OP_CLASS_OPTION_STORAGE,
    OP_CLASS_REF,
    OP_CLASS_RENAME_TO,
    OP_FAMILY_NAME,
    OP_FAMILY_REF,
    ...
    PLPGSQL,
    PLPGSQL_ALIAS_DECL,
    PLPGSQL_ALIAS_TARGET,
    PLPGSQL_ASSERT_STMT,
    PLPGSQL_ASSIGN_STMT,
    PLPGSQL_ASSIGN_TARGET,
    PLPGSQL_BLOCK,
    PLPGSQL_BODY,
    PLPGSQL_CALL_STMT,
    PLPGSQL_CASE_STMT,
    ...
    PLPGSQL_CURSOR_ARG,
    PLPGSQL_CURSOR_ARG_LIST,
    PLPGSQL_CURSOR_DECL,
    PLPGSQL_CURSOR_VARIABLE_REF,
    PLPGSQL_DECLARE_SECTION,
    PLPGSQL_DIAG_AREA,
    PLPGSQL_DIAG_ITEM,
    PLPGSQL_DIAG_ITEM_LIST,
    PLPGSQL_DIAG_KIND,
    PLPGSQL_DIAG_TARGET,
    PLPGSQL_DO_STMT,
    PLPGSQL_DYN_EXECUTE_STMT,
    PLPGSQL_ELSE_CLAUSE,
    PLPGSQL_ELSIF_CLAUSE,
    PLPGSQL_EXCEPTION_HANDLER,
    PLPGSQL_EXCEPTION_SECTION,
    PLPGSQL_EXEC_SQL_STMT,
    PLPGSQL_EXIT_STMT,
    PLPGSQL_EXIT_WHEN,
    PLPGSQL_FETCH_STMT,
    PLPGSQL_FOR_CURSOR_STMT,
    PLPGSQL_FOR_DYN_STMT,
    PLPGSQL_FOR_EACH_SLICE,
    PLPGSQL_FOR_EACH_STMT,
    PLPGSQL_FOR_I_STMT,
    PLPGSQL_FOR_QUERY_STMT,
    PLPGSQL_FOR_RANGE,
    PLPGSQL_FOR_VARIABLE,
    PLPGSQL_GET_DIAG_STMT,
    PLPGSQL_IF_STMT,
    PLPGSQL_INTO_CLAUSE,
    PLPGSQL_INTO_TARGET,
    PLPGSQL_INTO_TARGET_LIST,
    PLPGSQL_LABEL,
    PLPGSQL_LABEL_NAME,
    PLPGSQL_LABEL_NAME_REF,
    PLPGSQL_LOOP_STMT,
    PLPGSQL_MOVE_STMT,
    PLPGSQL_NOT_NULL,
    PLPGSQL_NULL_STMT,
    ...
    PLPGSQL_OPEN_QUERY,
    PLPGSQL_OPEN_STMT,
    PLPGSQL_OPTION_VALUE,
    PLPGSQL_PERCENT_ROWTYPE,
    PLPGSQL_PERFORM_STMT,
    PLPGSQL_RAISE_LEVEL,
    PLPGSQL_RAISE_MESSAGE,
    PLPGSQL_RAISE_OPTION_COLUMN,
    PLPGSQL_RAISE_OPTION_CONSTRAINT,
    PLPGSQL_RAISE_OPTION_DATATYPE,
    PLPGSQL_RAISE_OPTION_DETAIL,
    PLPGSQL_RAISE_OPTION_ERRCODE,
    PLPGSQL_RAISE_OPTION_HINT,
    PLPGSQL_RAISE_OPTION_MESSAGE,
    PLPGSQL_RAISE_OPTION_SCHEMA,
    PLPGSQL_RAISE_OPTION_TABLE,
    PLPGSQL_RAISE_STMT,
    PLPGSQL_RAISE_USING_CLAUSE,
    PLPGSQL_RETURN_NEXT_STMT,
    PLPGSQL_RETURN_QUERY_EXECUTE_STMT,
    PLPGSQL_RETURN_QUERY_STMT,
    PLPGSQL_RETURN_STMT,
    PLPGSQL_ROLLBACK_STMT,
    PLPGSQL_USING_CLAUSE,
    PLPGSQL_VAR_DECL,
    PLPGSQL_VAR_INIT,
    PLPGSQL_VAR_NAME,
    PLPGSQL_VAR_NAME_REF,
    PLPGSQL_WHILE_STMT,
    POLICY,
    POLICY_COMMAND,
    POLICY_COMMAND_ALL,
    POLICY_COMMAND_DELETE,
    POLICY_COMMAND_INSERT,
    POLICY_COMMAND_SELECT,
    POLICY_COMMAND_UPDATE,
    POLICY_REF,
    POLICY_RENAME_TO,
    POLICY_ROLES,
    PORTION_FROM_TO,
    ...
    PRIOR,
    PRIVILEGE_ALL_FUNCTIONS_IN_SCHEMA,
    PRIVILEGE_ALL_PROCEDURES_IN_SCHEMA,
    PRIVILEGE_ALL_ROUTINES_IN_SCHEMA,
    PRIVILEGE_ALL_SEQUENCES_IN_SCHEMA,
    PRIVILEGE_ALL_TABLES_IN_SCHEMA,
    PRIVILEGE_DATABASE,
    PRIVILEGE_DEFAULT,
    PRIVILEGE_DOMAIN,
    PRIVILEGE_FOREIGN_DATA_WRAPPER,
    PRIVILEGE_FOREIGN_SERVER,
    PRIVILEGE_FUNCTION,
    PRIVILEGE_LANGUAGE,
    ...
    PRIVILEGE_SEQUENCE,
    PRIVILEGE_TABLE,
    PRIVILEGE_TABLESPACE,
    PRIVILEGE_TARGET_FUNCTIONS,
    PRIVILEGE_TARGET_LARGE_OBJECTS,
    PRIVILEGE_TARGET_ROUTINES,
    PRIVILEGE_TARGET_SCHEMAS,
    PRIVILEGE_TARGET_SEQUENCES,
    PRIVILEGE_TARGET_TABLES,
    PRIVILEGE_TARGET_TYPES,
    PRIVILEGE_TYPE,
    PROCEDURE_NAME,
    PROCEDURE_NAME_REF,
    PROCEDURE_RENAME_TO,
    ...
    REINDEX_TARGET_DATABASE,
    REINDEX_TARGET_INDEX,
    REINDEX_TARGET_SCHEMA,
    REINDEX_TARGET_SYSTEM,
    REINDEX_TARGET_TABLE,
    RELATION_FROM_ITEM,
    RELATION_LIST,
    RELATION_NAME,
    RELATION_NAME_REF,
    ...
    ROLE_OPTION_ENCRYPTED_PASSWORD,
    ROLE_OPTION_GENERIC,
    ROLE_OPTION_INHERIT,
    ROLE_OPTION_IN_GROUP,
    ROLE_OPTION_IN_ROLE,
    ROLE_OPTION_LIST,
    ...
    ROLE_REF,
    ROLE_REF_CURRENT_ROLE,
    ROLE_REF_CURRENT_USER,
    ROLE_REF_LIST,
    ROLE_REF_SESSION_USER,
    ROLE_RENAME_TO,
    ROLLBACK_PREPARED,
    ...
    SET,
    SET_ACCESS_METHOD,
    SET_ALL_PUBLICATION_OBJECT_LIST,
    SET_CATALOG,
    SET_CLAUSE,
    SET_COLUMN_LIST,
    SET_COMPRESSION,
    ...
    XML_PARSE_FN,
    XML_PASSING_DOC,
    XML_PASSING_MECH_BY_REF,
    XML_PASSING_MECH_BY_VALUE,
    XML_PI_FN,
    XML_PI_TARGET,
    XML_ROOT_FN,
